...
<div class="wrapper-frame-local-nav open" id="menuAreaAddon"
	...
	<div class="wrapper-local-nav" data-cid="menuSection3">
		<ul data-role="menu.itemContainer" class="on">
			<li id="201" data-role="menu.listedItem" class="active" data-cid="201"><a
				...
				<ul data-role="menu.itemContainer">
					<li id="540" 
						...
						<div class="nav-option" data-role="menu.listedItem" data-cid="540">
					...
					<li id="539" class="" data-cid="539"><a
					...
					<li id="549" data-ecpath="ecp.ecp050m∫menu∫∫section4∫∫549∫"
						data-role="menu.listedItem" class="active" data-cid="549"><a
						href="/movements/transferGet"
						data-level="{{level}}" data-role="menu.anchor" target=""
						data-index="0" id="ma549" data-cid="549" class=""><font
							style="vertical-align: inherit;"><font
								style="vertical-align: inherit;"> 倉庫移動状況 </font></font></a>
						<div class="nav-option" data-role="menu.listedItem" data-cid="549">
			...
			<li id="202" data-role="menu.listedItem" class="collapsed" data-cid="202"><a
				...
				<div class="nav-option" data-role="menu.listedItem" data-cid="202">
...
<div class="wrapper-frame-body">
	<div style="display: block;">
		...
		<div id="mainPage" data-ecpageid="ESJ013R_5"
					...
					<div class="wrapper-toolbar" style="max-width: 755px;">
						<div class="pull-left">
							<span id="btn-header-bookmark" class="page-name page-bookmark"><font
								style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">倉庫移動状況</font></font></span> <span
						...
						<div class="pull-right">
							<div class="control-set  hidden  ">
								<div class="control wrapper-title-simple-search  "
									data-ecpath="ESJ013R_5∫header∫∫∫∫__headerQuick∫">
							...
							<div class="control-set     hidden">
								<div class="control   "
									data-ecpath="ESJ013R_5∫header∫∫∫∫tgHeaderSearch∫">
							...
							<div class="control-set    ">
								<div class="control   "
									data-ecpath="ESJ013R_5∫header∫∫∫∫tgHeaderOption∫">
							...
							<div class="control-set    ">
								<div class="control   "
									data-ecpath="ESJ013R_5∫header∫∫∫∫helper∫">
				...
				<div class="wrapper-header-search"
					...
					<ul class="nav nav-tabs" style="">
						<li id="all" class="active" data-tabid="all"
							data-ecpath="ESJ013R_5∫header∫∫tab∬a1zwov03∫∫∫"
							data-function="tab" data-function-id="tabitem"><a
							href="javascript:;" class="cursor-pointer" id="all"
							data-tabid="all" data-ecpath="ESJ013R_5∫header∫∫tab∬a1zwov03∫∫∫"
					...
					<div class="tab-content" style="">
						<div class="tab-pane" style="display: block;"
							data-container-id="ESJ013R_5∫all">
							<ul class="wrapper-form wrapper-form-state-1"
								data-formid="form∬o1dc2w69"
								data-ecpath="ESJ013R_5∫header∫all∫form∬o1dc2w69∫∫∫">
								<li data-listid="cmbSumFlag" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlag_tempType∫cmbSumFlag">
												...
												<span class="form-radio" data-cid="cmbSumFlag_tempType"
													...
													name="cmbSumFlag_tempType_ESJ013R_5_all" data-index="0"
													id="control-all--ESJ013R_5-cmbSumFlag_tempType-0"
													checked=""><label data-role="widget-focus"
													for="control-all--ESJ013R_5-cmbSumFlag_tempType-0"
													...
													data-cid="cmbSumFlag_tempType" data-pcid="cmbSumFlag"
													name="cmbSumFlag_tempType_ESJ013R_5_all" data-index="1"
													id="control-all--ESJ013R_5-cmbSumFlag_tempType-1"><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-cmbSumFlag_tempType-1"
													data-cid="cmbSumFlag_tempType" data-pcid="cmbSumFlag"><font
														style="vertical-align: inherit;"><font
										...
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlag_radio∫cmbSumFlag">
										...
										<div class="control-set  hidden">
											<div class="control-set  hidden">
												<div class="control  {{style.css}} "
													data-ecpath="ESJ013R_5∫header∫all∫∫∫balanceCode_1∫cmbSumFlag_userAggregate">
													<div>
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerSelect_1∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_1∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_1"
														...
														data-popoverindex="1"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_1∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_1"
														...
														data-popoverindex="2"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} "
													data-ecpath="ESJ013R_5∫header∫all∫∫∫balanceCode_2∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerSelect_2∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_2∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_2"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_2∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="3"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_2∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_2"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_2∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="4"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫balanceCode_3∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerSelect_3∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_3∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_3"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_3∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="5"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_3∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_3"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_3∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="6"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫balanceCode_4∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerSelect_4∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_4∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_4"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_4∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="7"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_4∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_4"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_4∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="8"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫balanceCode_5∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerSelect_5∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_5∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_5"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn1_5∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="9"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_5∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_5"
														...
														data-ecpath="ESJ013R_5∫header∫all∫∫∫innerBtn2_5∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="10"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlag_userAggregate_multiCode∫cmbSumFlag_userAggregate"
											...
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlag_userAggregate_comparePeriod∫cmbSumFlag_userAggregate">
													...
													<span class="form-radio"
														...
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"
														name="cmbSumFlag_userAggregate_comparePeriod_ESJ013R_5_all"
														data-index="0"
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-0"
														checked=""><label data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-0"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESJ013R_5_all"
														data-index="1"
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-1"><label
														data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-1"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESJ013R_5_all"
														data-index="2"
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-2"><label
														data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-2"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESJ013R_5_all"
														data-index="3"
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-3"><label
														data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-3"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESJ013R_5_all"
														data-index="4"
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-4"><label
														data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_comparePeriod-4"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
											...
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlag_userAggregate_othersChk∫cmbSumFlag_userAggregate">
													...
													<span class="form-checkbox"
														...
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-0"
														class=""><label data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-0"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														...
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-1"
														class=""><label data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-1"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														data-pcid="cmbSumFlag_userAggregate" class=""><font
															style="vertical-align: inherit;"><font
														...
														id="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-2"
														class=""><label data-role="widget-focus"
														for="control-all--ESJ013R_5-cmbSumFlag_userAggregate_othersChk-2"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														data-pcid="cmbSumFlag_userAggregate" class=""><font
															style="vertical-align: inherit;"><font
									...
									<div class="form">
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlagDate_SELECT∫cmbSumFlagDate">
										...
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlagDate_DATE∫cmbSumFlagDate">
												...
												<div>
													<span data-role="click.addonTitle" data-role-index="0"
														...
														data-pcid="cmbSumFlagDate"><font
														style="vertical-align: inherit;"><font
															style="vertical-align: inherit;">今月（〜今日）</font></font></span>
												</div>
										...
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cmbSumFlagDate_CALC∫cmbSumFlagDate">
								...
								<li data-listid="txtSWhCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd∫"
												data-cid="txtSWhCd">
								...
								<li data-listid="txtSWhCd_Level" class="hidden hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd_Level∫"
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESJ013R_5-txtSWhCd_Level-tabUnsent"
														checked=""><label data-role="code.sidelabel"
														for="control-all--ESJ013R_5-txtSWhCd_Level-tabUnsent"><font
															style="vertical-align: inherit;"><font
								...
								<li data-listid="txtSWhCd_From"
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd_From∫"
								...
								<li data-listid="txtSWhCd_FromLevel" class="hidden hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd_FromLevel∫"
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESJ013R_5-txtSWhCd_FromLevel-tabUnsent"
														checked=""><label data-role="code.sidelabel"
														for="control-all--ESJ013R_5-txtSWhCd_FromLevel-tabUnsent"><font
															style="vertical-align: inherit;"><font
																style="vertical-align: inherit;">サブグループを含む検索</font></font></label></span></span>
											</div>
										</div>
								...
								<li data-listid="txtSWhCd_To"
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd_To∫"
								...
								<li data-listid="txtSWhCd_ToLevel" class="hidden hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWhCd_ToLevel∫"
																...
																<div data-role="code.container">
																	<div class="tags-input-typeahead"
																		...
																		<input type="text"
																			...
																			placeholder="受け取る倉庫階層グループ" value="">
																	</div>
																</div>
															</div>
														</div>
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESJ013R_5-txtSWhCd_ToLevel-tabUnsent"
														checked=""><label data-role="code.sidelabel"
														for="control-all--ESJ013R_5-txtSWhCd_ToLevel-tabUnsent"><font
															style="vertical-align: inherit;"><font
																style="vertical-align: inherit;">サブグループを含む検索</font></font></label></span></span>
											</div>
										</div>
								...
								<li data-listid="txtPjtCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtPjtCd∫"
												data-cid="txtPjtCd">
								...
								<li data-listid="txtPjtGroup1" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtPjtGroup1∫"
								...
								<li data-listid="txtPjtGroup2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtPjtGroup2∫"
								...
								<li data-listid="txtSProdCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSProdCd∫"
												data-cid="txtSProdCd">
								...
								<li data-listid="rbProdChk" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫rbProdChk∫">
												...
												<span class="form-checkbox" data-cid="rbProdChk"><input
													...
													id="control-all--ESJ013R_5-rbProdChk-0" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-0"
													...
													id="control-all--ESJ013R_5-rbProdChk-1" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-1"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-rbProdChk-2" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-2"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-rbProdChk-3" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-3"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-rbProdChk-4" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-4"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-rbProdChk-5" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-5"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-rbProdChk-6" class="" checked=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-rbProdChk-6"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
								...
								<li data-listid="txtClassCd1" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtClassCd1∫"
								...
								<li data-listid="txtClassCd2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtClassCd2∫"
								...
								<li data-listid="txtClassCd3" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtClassCd3∫"
								...
								<li data-listid="txtTreeGroupCd" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtTreeGroupCd∫"
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESJ013R_5-txtTreeGroupCd-tabUnsent"
														checked=""><label data-role="code.sidelabel"
														for="control-all--ESJ013R_5-txtTreeGroupCd-tabUnsent"><font
															style="vertical-align: inherit;"><font
																style="vertical-align: inherit;">サブグループを含む検索</font></font></label></span></span>
											</div>
										</div>
								...
								<li data-listid="txtEmpCd" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtEmpCd∫"
												data-cid="txtEmpCd">
								...
								<li data-listid="txtSWord" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtSWord∫">
								...
								<li data-listid="txtProcNo" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtProcNo∫"
												data-cid="txtProcNo">
								...
								<li data-listid="txtPDes2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtPDes2∫">
								...
								<li data-listid="qty" class="hidden"><div class="title"
									...
									<div class="form">
										<div class="control-set hidden">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫qty_BETWEEN∫qty">
										...
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESJ013R_5∫header∫all∫∫∫qty_CALC∫qty">
										...
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESJ013R_5∫header∫all∫∫∫qty_NOFIELD∫qty">
								...
								<li data-listid="slipStatusInfo" class="hidden"><div
									...
									<div class="form">
										<div class="control-set hidden">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫slipStatusInfo∫slipStatusInfo">
												...
												<span class="form-checkbox" data-cid="slipStatusInfo"
													...
													id="control-all--ESJ013R_5-slipStatusInfo-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-slipStatusInfo-0"
													...
													id="control-all--ESJ013R_5-slipStatusInfo-1" class=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-slipStatusInfo-1"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-slipStatusInfo-2" class=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-slipStatusInfo-2"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
													...
													id="control-all--ESJ013R_5-slipStatusInfo-3" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESJ013R_5-slipStatusInfo-3"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
										...
										<div class="control-set hidden">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫slipStatusInfoY∫slipStatusInfo"
								...
								<li data-listid="txtFirstWriteID" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtFirstWriteID∫"
								...
								<li data-listid="txtLastEditID" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫txtLastEditID∫"
								...
								<li data-listid="formList" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫formList∫">
												...
												<button data-service="layer.selectbox" data-index="0"
													...
													<div class="selectbox-label">
														<font style="vertical-align: inherit;"><font
															style="vertical-align: inherit;">倉庫移動状況</font></font>
													</div>
												</button>
												<input type="text" data-service="layer.autocomplete"
								...
								<li data-listid="formClass" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫cbRptConfirm∫formClass">
												...
												<span class="form-checkbox" data-cid="cbRptConfirm"><input
													...
													id="control-all--ESJ013R_5-cbRptConfirm-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-cbRptConfirm-0"
								...
								<li data-listid="linkSortTotal" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫linkSortTotal∫">
									...
									<div class="form">
										<div class="control-set">
											<div class="control  flex-none "
												data-ecpath="ESJ013R_5∫header∫all∫∫∫dataTypeGraph∫dataViewType">
												...
												<span class="form-checkbox" data-cid="dataTypeGraph"
													...
													id="control-all--ESJ013R_5-dataTypeGraph-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESJ013R_5-dataTypeGraph-0"
													data-cid="dataTypeGraph" data-pcid="dataViewType" class=""><font
														style="vertical-align: inherit;"><font
															style="vertical-align: inherit;">グラフで見る</font></font></label></span>
											</div>
											<div class="control  flex-none hidden"
												data-ecpath="ESJ013R_5∫header∫all∫∫∫dataTypeLink∫dataViewType">
					...
					<div class="wrapper-toolbar header-search-btn-group">
						<div class="pull-left">
							<div class="control-set">
								<div class="control   "
									data-ecpath="ESJ013R_5∫header∫∫∫∫searchGroup∫">
								...
								<div class="control "
									data-ecpath="ESJ013R_5∫header∫∫∫∫simpleSearch∫">
								...
								<div class="control "
									data-ecpath="ESJ013R_5∫header∫∫∫∫simpleSearch∫">
									<button id="simpleSearch"
										class="btn btn-default btn-sm last-child" data-index="7"
										data-cid="simpleSearch"
										data-ecpath="ESJ013R_5∫header∫∫∫∫simpleSearch∫"
								...
								<div class="control   "
									data-ecpath="ESJ013R_5∫header∫∫∫∫rewrite∫">
			...
			<div class="contents variable-reset"
				...
				<div id="grid1-ESJ013R" data-gid="grid1-ESJ013R"
					class="__ecGridContainer  wrapper-grid" data-layouttype="grid"
					style=""></div>
				<div id="graph-ESJ013R_5"
					class="wrapper-chart legend-right legend-middle">
					<div class="chart">
						<div id="graph-ESJ013R_5_ecChartLayout" class="ct-chart"></div>
					</div>
					<div class="legend" id="graph-ESJ013R_5_ecChartLegend">
			...
			<div class="footer" style="display: block;">
				...
				<div class="wrapper-toolbar toolbar-collapse  ">
					<div class="pull-left">
						<div class="control-set    ">
							<div class="control   "
								data-ecpath="ESJ013R_5∫footer∫∫∫∫group0printHtml∫">
						...
						<div class="control-set  hidden  ">
							<div class="control   "
								data-ecpath="ESJ013R_5∫footer∫∫∫∫graphFilter∫">
						...
						<div class="control-set    ">
							<div class="control   "
								data-ecpath="ESJ013R_5∫footer∫∫∫∫outputExcel∫">
						...
						<div class="control-set  hidden  ">
							<div class="control   "
								data-ecpath="ESJ013R_5∫footer∫∫∫∫moreData∫">

								<button id="moreData"
									class="btn btn-default first-child last-child" data-index="0"
									data-cid="moreData" data-ecpath="ESJ013R_5∫footer∫∫∫∫moreData∫"
									data-role="{{ecRole}}">
									<font style="vertical-align: inherit;"><font
