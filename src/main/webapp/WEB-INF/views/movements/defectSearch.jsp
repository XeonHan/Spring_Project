	...
	<div class="wrapper-local-nav"
		...
		<ul data-role="menu.itemContainer" class="on">
			<li id="201" data-ecpath="ecp.ecp050m∫menu∫∫section3∫∫201∫"
				data-role="menu.listedItem" class="" data-cid="201"><a href="#"
			...
			<li id="203" data-ecpath="ecp.ecp050m∫menu∫∫section3∫∫203∫"
				...
				<ul data-role="menu.itemContainer">
					<li id="544" data-ecpath="ecp.ecp050m∫menu∫∫section4∫∫544∫"
						...
						href="/movements/defectist" data-level="{{level}}"
					...
					<li id="551" data-ecpath="ecp.ecp050m∫menu∫∫section4∫∫551∫"
						data-role="menu.listedItem" class="active" data-cid="551"><a
...
<div class="wrapper-frame-body">
	<div style="display: block;">
		...
		<div id="mainPage" data-ecpageid="ESM010R_40"
					...
					<div class="wrapper-toolbar" style="max-width: 755px;">
						<div class="pull-left">
							<span id="btn-header-bookmark" class="page-name page-bookmark"><font
								style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">不良処理状況</font></font></span> <span
						...
						<div class="pull-right">
							<div class="control-set  hidden  ">
								<div class="control wrapper-title-simple-search  "
									data-ecpath="ESM010R_40∫header∫∫∫∫__headerQuick∫">
							...
							<div class="control-set     hidden">
								<div class="control   "
									data-ecpath="ESM010R_40∫header∫∫∫∫tgHeaderSearch∫">
							...
							<div class="control-set    ">
								<div class="control   "
									data-ecpath="ESM010R_40∫header∫∫∫∫tgHeaderOption∫">
							...
							<div class="control-set    ">
								<div class="control   "
									data-ecpath="ESM010R_40∫header∫∫∫∫helper∫">
				...
				<div class="wrapper-header-search"
					...
					<ul class="nav nav-tabs" style="">
						<li id="all" class="active" data-tabid="all"
							data-ecpath="ESM010R_40∫header∫∫tab∬fj3sw2se∫∫∫"
							data-function="tab" data-function-id="tabitem"><a
							href="javascript:;" class="cursor-pointer" id="all"
							data-tabid="all" data-ecpath="ESM010R_40∫header∫∫tab∬fj3sw2se∫∫∫"
					...
					<div class="tab-content" style="">
						<div class="tab-pane" style="display: block;"
							data-container-id="ESM010R_40∫all">
							<ul class="wrapper-form wrapper-form-state-1"
								data-formid="form∬j1kpibm4"
								data-ecpath="ESM010R_40∫header∫all∫form∬j1kpibm4∫∫∫">
								<li data-listid="cmbSumFlag" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlag_tempType∫cmbSumFlag">
												...
												<span class="form-radio" data-cid="cmbSumFlag_tempType"
													...
													name="cmbSumFlag_tempType_ESM010R_40_all" data-index="0"
													id="control-all--ESM010R_40-cmbSumFlag_tempType-0"
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-cmbSumFlag_tempType-0"
													...
													data-cid="cmbSumFlag_tempType" data-pcid="cmbSumFlag"
													name="cmbSumFlag_tempType_ESM010R_40_all" data-index="1"
													id="control-all--ESM010R_40-cmbSumFlag_tempType-1"><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-cmbSumFlag_tempType-1"
													data-cid="cmbSumFlag_tempType" data-pcid="cmbSumFlag"><font
														style="vertical-align: inherit;"><font
										...
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlag_radio∫cmbSumFlag">
										...
										<div class="control-set  hidden">
											<div class="control-set  hidden">
												<div class="control  {{style.css}} "
													data-ecpath="ESM010R_40∫header∫all∫∫∫balanceCode_1∫cmbSumFlag_userAggregate">
													<div>
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerSelect_1∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_1∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_1"
														...
														data-popoverindex="82"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_1∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_1"
														...
														data-popoverindex="83"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} "
													data-ecpath="ESM010R_40∫header∫all∫∫∫balanceCode_2∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerSelect_2∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_2∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_2"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_2∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="84"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_2∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_2"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_2∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="85"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫balanceCode_3∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerSelect_3∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_3∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_3"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_3∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="86"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_3∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_3"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_3∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="87"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫balanceCode_4∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerSelect_4∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_4∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_4"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_4∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="88"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_4∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_4"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_4∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="89"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control  {{style.css}} hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫balanceCode_5∫cmbSumFlag_userAggregate">
													<div>
														<span ,="" class="label label-default label-light "
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerSelect_5∫cmbSumFlag_userAggregate">
												...
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_5∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn1_5"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn1_5∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="오름차순"
														data-popoverindex="90"></button>
												</div>
												<div class="control  flex-none hidden"
													data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_5∫cmbSumFlag_userAggregate">
													...
													<button id="innerBtn2_5"
														...
														data-ecpath="ESM010R_40∫header∫all∫∫∫innerBtn2_5∫cmbSumFlag_userAggregate"
														data-role="{{ecRole}}" data-original-title="소계표시"
														data-popoverindex="91"></button>
												</div>
											</div>
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlag_userAggregate_multiCode∫cmbSumFlag_userAggregate"
											...
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlag_userAggregate_comparePeriod∫cmbSumFlag_userAggregate">
													...
													<span class="form-radio"
														...
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"
														name="cmbSumFlag_userAggregate_comparePeriod_ESM010R_40_all"
														data-index="0"
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-0"
														checked=""><label data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-0"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESM010R_40_all"
														data-index="1"
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-1"><label
														data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-1"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESM010R_40_all"
														data-index="2"
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-2"><label
														data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-2"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESM010R_40_all"
														data-index="3"
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-3"><label
														data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-3"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
														...
														name="cmbSumFlag_userAggregate_comparePeriod_ESM010R_40_all"
														data-index="4"
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-4"><label
														data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_comparePeriod-4"
														data-cid="cmbSumFlag_userAggregate_comparePeriod"
														data-pcid="cmbSumFlag_userAggregate"><font
															style="vertical-align: inherit;"><font
											...
											<div class="control-set  hidden">
												<div class="control   "
													data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlag_userAggregate_othersChk∫cmbSumFlag_userAggregate">
													...
													<span class="form-checkbox"
														...
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-0"
														class=""><label data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-0"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														...
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-1"
														class=""><label data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-1"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														data-pcid="cmbSumFlag_userAggregate" class=""><font
															style="vertical-align: inherit;"><font
														...
														id="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-2"
														class=""><label data-role="widget-focus"
														for="control-all--ESM010R_40-cmbSumFlag_userAggregate_othersChk-2"
														data-cid="cmbSumFlag_userAggregate_othersChk"
														data-pcid="cmbSumFlag_userAggregate" class=""><font
															style="vertical-align: inherit;"><font
									...
									<div class="form">
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlagDate_SELECT∫cmbSumFlagDate">
										...
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlagDate_DATE∫cmbSumFlagDate">
										...
										<div class="control-set  hidden">
											<div class="control   hidden"
												data-ecpath="ESM010R_40∫header∫all∫∫∫cmbSumFlagDate_CALC∫cmbSumFlagDate">
								...
								<li data-listid="txtSWhCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtSWhCd∫"
												data-cid="txtSWhCd">
								...
								<li data-listid="txtTreeWhCd" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtTreeWhCd∫"
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESM010R_40-txtTreeWhCd-0" checked=""><label
														data-role="code.sidelabel"
														for="control-all--ESM010R_40-txtTreeWhCd-0"><font
															style="vertical-align: inherit;"><font
								...
								<li data-listid="txtPjtCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtPjtCd∫"
												data-cid="txtPjtCd">
								...
								<li data-listid="txtPjtGroup1" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtPjtGroup1∫"
								...
								<li data-listid="txtPjtGroup2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtPjtGroup2∫"
								...
								<li data-listid="txtSProdCd" class="form-collapse collapsed"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtSProdCd∫"
												data-cid="txtSProdCd">
								...
								<li data-listid="rbProdChk" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫rbProdChk∫">
												...
												<span class="form-checkbox" data-cid="rbProdChk"><input
													...
													id="control-all--ESM010R_40-rbProdChk-0" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-0"
													...
													id="control-all--ESM010R_40-rbProdChk-1" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-1"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-rbProdChk-2" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-2"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-rbProdChk-3" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-3"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-rbProdChk-4" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-4"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-rbProdChk-5" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-5"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-rbProdChk-6" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-rbProdChk-6"
													data-cid="rbProdChk" class=""><font
														style="vertical-align: inherit;"><font
								...
								<li data-listid="txtClassCd1" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtClassCd1∫"
								...
								<li data-listid="txtClassCd2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtClassCd2∫"
								...
								<li data-listid="txtClassCd3" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtClassCd3∫"
								...
								<li data-listid="txtTreeGroupCd" class="hidden"><div
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtTreeGroupCd∫"
												...
												<span class="control-inline hidden"><span
													class="form-checkbox"><span>&nbsp;</span><input
														...
														id="control-all--ESM010R_40-txtTreeGroupCd-0" checked=""><label
														data-role="code.sidelabel"
														for="control-all--ESM010R_40-txtTreeGroupCd-0"><font
															style="vertical-align: inherit;"><font
																style="vertical-align: inherit;">サブグループを含む検索</font></font></label></span></span>
											</div>
										</div>
								...
								<li data-listid="txtEmpCd" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtEmpCd∫"
												data-cid="txtEmpCd">
								...
								<li data-listid="ddlBadType" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫ddlBadType∫"
												data-cid="ddlBadType">
								...
								<li data-listid="ddlBadFlag" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫ddlBadFlag∫">
												...
												<button data-service="layer.selectbox" data-index="0"
													...
													<div class="selectbox-label">
														<font style="vertical-align: inherit;"><font
															style="vertical-align: inherit;">全体</font></font>
													</div>
												</button>
												<input type="text" data-service="layer.autocomplete"
													data-cid="ddlBadFlag" data-index="0"
													data-role="select.selectbox" data-role-index="0"
													class="hidden form-control select-direct-input">
											</div>
										</div>
								...
								<li data-listid="txtSWord" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtSWord∫">
								...
								<li data-listid="txtProcNo" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtProcNo∫"
												data-cid="txtProcNo">
								...
								<li data-listid="sizeDes" class="hidden"><div class="title"
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫sizeDes∫">
								...
								<li data-listid="txtPDes2" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtPDes2∫">
								...
								<li data-listid="slipStatusInfo" class="hidden"><div
									...
									<div class="form">
										<div class="control-set hidden">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫slipStatusInfo∫slipStatusInfo">
												...
												<span class="form-checkbox" data-cid="slipStatusInfo"
													...
													id="control-all--ESM010R_40-slipStatusInfo-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-slipStatusInfo-0"
													...
													id="control-all--ESM010R_40-slipStatusInfo-1" class=""><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-slipStatusInfo-1"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-slipStatusInfo-2" class=""><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-slipStatusInfo-2"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
													...
													id="control-all--ESM010R_40-slipStatusInfo-3" class=""
													checked=""><label data-role="widget-focus"
													for="control-all--ESM010R_40-slipStatusInfo-3"
													data-cid="slipStatusInfo" data-pcid="slipStatusInfo"
													class=""><font style="vertical-align: inherit;"><font
										...
										<div class="control-set hidden">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫slipStatusInfoY∫slipStatusInfo"
								...
								<li data-listid="txtFirstWriteID" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtFirstWriteID∫"
								...
								<li data-listid="txtLastEditID" class="hidden"><div
									...
									<div class="form">
										<div class="control-set  hidden  ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫txtLastEditID∫"
								...
								<li data-listid="formList" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫formList∫">
								...
								<li data-listid="formClass" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫cbRptConfirm∫formClass">
												...
												<span class="form-checkbox" data-cid="cbRptConfirm"><input
													...
													id="control-all--ESM010R_40-cbRptConfirm-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-cbRptConfirm-0"
								...
								<li data-listid="linkSortTotal" class=""><div class="title"
									...
									<div class="form">
										<div class="control-set    ">
											<div class="control   "
												data-ecpath="ESM010R_40∫header∫all∫∫∫linkSortTotal∫">
									...
									<div class="form">
										<div class="control-set">
											<div class="control  flex-none "
												data-ecpath="ESM010R_40∫header∫all∫∫∫dataTypeGraph∫dataViewType">
												...
												<span class="form-checkbox" data-cid="dataTypeGraph"
													...
													id="control-all--ESM010R_40-dataTypeGraph-0" class=""><label
													data-role="widget-focus"
													for="control-all--ESM010R_40-dataTypeGraph-0"
													data-cid="dataTypeGraph" data-pcid="dataViewType" class=""><font
														style="vertical-align: inherit;"><font
															style="vertical-align: inherit;">グラフで見る</font></font></label></span>
											</div>
											<div class="control  flex-none hidden"
												data-ecpath="ESM010R_40∫header∫all∫∫∫dataTypeLink∫dataViewType">
					...
					<div class="wrapper-toolbar header-search-btn-group">
						<div class="pull-left">
							<div class="control-set">
								<div class="control   "
									data-ecpath="ESM010R_40∫header∫∫∫∫searchGroup∫">
								...
								<div class="control "
									data-ecpath="ESM010R_40∫header∫∫∫∫simpleSearch∫">
								...
								<div class="control   "
									data-ecpath="ESM010R_40∫header∫∫∫∫rewrite∫">
			...
			<div class="contents variable-reset"
				...
				<div id="grid1-ESM010R" data-gid="grid1-ESM010R"
					class="__ecGridContainer  wrapper-grid" data-layouttype="grid"
					style=""></div>
				<div id="graph-ESM010R_40"
					class="wrapper-chart legend-right legend-middle">
					<div class="chart">
						<div id="graph-ESM010R_40_ecChartLayout" class="ct-chart"></div>
					</div>
					<div class="legend" id="graph-ESM010R_40_ecChartLegend">
			...
			<div class="footer" style="display: block;">
				...
				<div class="wrapper-toolbar toolbar-collapse  ">
					<div class="pull-left">
						<div class="control-set    ">
							<div class="control   "
								data-ecpath="ESM010R_40∫footer∫∫∫∫group0printHtml∫">
						...
						<div class="control-set  hidden  ">
							<div class="control   "
								data-ecpath="ESM010R_40∫footer∫∫∫∫graphFilter∫">
						...
						<div class="control-set    ">
							<div class="control   "
								data-ecpath="ESM010R_40∫footer∫∫∫∫outputExcel∫">
						...
						<div class="control-set  hidden  ">
							<div class="control   "
								data-ecpath="ESM010R_40∫footer∫∫∫∫moreData∫">
