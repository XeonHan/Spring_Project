		...
		<div class="col-lg-6 text-right">
			<form id="searchForm" action="/basicRegi/specList" method="get">
				<select name="type">
					...
					<option value="N"
						<c:out value="${pageMaker.cri.type eq 'N' ? 'selected':''}"/>>특별단가그룹명</option>
				...
				<div class="modal-body">
					<div class="panel-body">
						<div class="form-group">
							<label>특별단가그룹코드(40000~49999)</label><input class="form-control"
...
$(document).ready(function () {
    ...
    specRegisterModal.on('show.bs.modal', function (e) {
        getSpecCode(); 
    });
