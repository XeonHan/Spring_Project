			...
			<c:forEach items="${companyList}" var="company">
				<tr>
					...
					<td><a class='move' href='#' data-toggle="modal"
						...
						data-item-code="${company.company_code}"
						data-item-name="${company.company_name}"> <c:out
	...
	<div class="row">
		...
		<div class="col-lg-6 text-right">
			<form id="searchForm" action="/basicRegi/companyList" method="get">
				...
				<button class="btn btn-default" onclick="validateSearch()">검색</button>
			</form>
		</div>
	</div>
</div>
			...
			<form role="form" action="basicRegi/companyRegister" method="POST">
				<div class="modal-body">
					<div class="panel-body">
						...
						<div class="form-group">
							<label>검색창내용</label><input class="form-control"
								name="company_search">
						</div>
						<div class="form-group">
							<label>사용구분</label> <input type="checkbox" name="company_usage"
								value="사용"> 사용 <input type="checkbox"
								name="company_usage" value="미사용"> 미사용
						</div>
						<div class="form-group">
    ...
    $(".move").on("click", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Assuming company_usage is a checkbox, use prop() to set its state
                $("#companyModifyModal input[name='company_usage']").prop("checked", data.company_usage);
...
function registerCompany() {
    ...
    $.ajax({
        ...
        data: {
            ...
            company_usage: $("input[name='company_usage']:checked").val(), // Assuming company_usage is a checkbox
...
function modifyCompany() {
    ...
    var companyUsage = $("#companyModifyModal input[name='company_usage']:checked").val(); // Assuming company_usage is a checkbox
